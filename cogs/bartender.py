...
class Bartender:
    ...
    def __init__(self,bot):
        ...
        self.items = [["beer", ":beer:", 2], ["wine", ":wine_glass:", 2], ["cocktail", ":cocktail:", 4], ["tropical", ":tropical_drink:", 5], ["sake", ":sake:", 4], ["champagne", ":champagne:", 30], ["tea", ":tea:", 1], ["coffee", ":coffee:", 1], ["water", ":potable_water:",1],["soju",":flag_kr:",29],["mango juice",":lemon:",5],["whiskey",":tumbler_glass:",69],["melon soda",":melon:",8],["white russian",":white_large_square: :flag_ru:",50],["dr pepper",":hot_pepper:",9],["milk", ":milk:", 5],["chocolate milk", ":chocolate_bar: :milk:", 5],["scotch",":scotch:", 5]]
    ...
    async def buy(self, ctx, amount : int, drink):
        ...
        if econ.bank.can_spend(author, price):
            ...
            try:
                ...
                text_num = str(amount)
            await self.bot.reply("Sorry mate, you don't have enough money for {0} {1}.  It costs {2}.".format(text_num, drink, price))
