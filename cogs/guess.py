...
class Guess:
    ...
    async def mycom(self):
        ...
        items = ["here", "are", "some", "strings", "of", "which", "we", "will",
                 ...
                 "loop", "in", "else", "break", "empty", "mocha", "matcha", "money", "spam", "jazz", "jam",
                 "spaz", "binder", "jokes", "chemistry", "person", "matcha", "night", "everyone", "pasta", "craving",
                 ...
                 "failed", "wood", "stone", "cobblestone", "blanket", "ore", "chest", "poster", "hash",
                 "secure", "magical", "never", "public", "private", "key", "encryption", "cypher", "cryptogram", "theory",
                 "open", "thread", "ripper", "core", "graphical", "graphics", "asymmetrical", "symmetrical"]
